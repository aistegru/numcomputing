...
# plotting the graph for figure(b)
M_prime = np.linspace(20, 40, 1000)

# how the usual graph looks like
plt.plot(M, C[T-2,:], '.', markersize=1)
# interpolated one
plt.plot(M_prime, interpolated(M, C[T - 2, :], M_prime), '.', markersize=1)
